...
crf_sup = ConditionalRandomField(entrain.tagset, entrain.vocab)  # randomly initialized parameters  
crf_sup.train(corpus=ensup, loss=loss_dev, reg=1.0, lr=0.05, minibatch_size=10,
          save_path="ensup_crf.pkl")

crf_train = ConditionalRandomField(entrain.tagset, entrain.vocab)  # randomly initialized parameters  
crf_train.train(corpus=entrain, loss=loss_dev, reg=1.0, lr=0.05, minibatch_size=10,
          save_path="entrain_crf.pkl")
...
look_at_your_data(crf_train, endev, 10)
